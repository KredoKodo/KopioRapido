...
public interface IFileOperationService
{
    ...
    Task<CopyOperation> StartMoveAsync(string source, string destination, IProgress<FileTransferProgress>? progress = null, CancellationToken cancellationToken = default);
    Task<CopyOperation> StartMirrorAsync(string source, string destination, IProgress<FileTransferProgress>? progress = null, CancellationToken cancellationToken = default);
    Task<VerificationResult> StartVerifyAsync(string source, string destination, IProgress<FileTransferProgress>? progress = null, CancellationToken cancellationToken = default);
